...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    setSpeedPub = table.getDoubleTopic("Set Speed").publish();
  ...
  public void autonomousPeriodic() {
    speedPub.set(m_robotContainer.getSpeed());
    setSpeedPub.set(m_robotContainer.getSetSpeed());
    distancePub.set(m_robotContainer.getDistance());
  }
